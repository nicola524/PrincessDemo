package it.nicolabrogelli.bluetoothlib.util;
...
public class CHexConver
{
	...
	/** 
	 * La stringa viene convertita in una stringa esadecimale
	 * @param str String La stringa ASCII da convertire
	 * @return String Spazi separati tra ogni byte, ad esempio: [61 6C 6B]
	 */  
